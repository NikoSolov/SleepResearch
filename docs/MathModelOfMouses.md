...
- $\mathbf{P_M}=\left(R_M \atop H-R_M\right)$ - мышь на старте с заданным радиусом $R_M$
- $\mathbf{P_H}=\left(W-R_H \atop R_H\right)$ - нора с заданным радиусом $R_H$
...
- $\mathbf{S_T} = \left(W-R_H-2\sqrt{R_H R_M} \atop R_M \right)$ - верхняя критическая позиция, касается верхнего края окна и левее норы
- $\mathbf{S_B} = \left(W-R_H \atop R_H+2\sqrt{R_H R_M} \right)$ - верхняя критическая позиция, касается правого края окна и ниже норы
...
$$
\begin{array}{l}
y=\dfrac{y_1-y_0}{(x_1-x_0)^2}\cdot(x-x_0)^2+y_0,\\\
...
$$
\begin{array}{l}
T_{1T}: y=\dfrac{\mathbf{S_T}_y(q)-\mathbf{P_M}_y}{(\mathbf{S_T}_x(q)-\mathbf{P_M}_x)^2}\cdot(x-\mathbf{P_M}_x)^2+\mathbf{P_M}_y,\\\
T_{2T}: x=\dfrac{(\mathbf{S_T}_x(q)-\mathbf{P_M}_x)}{(\mathbf{S_T}_y(q)-\mathbf{P_M}_y)^2}\cdot(y-\mathbf{P_M}_y)^2+\mathbf{P_M}_x, \\\
T_{1B}: y=\dfrac{\mathbf{S_B}_y(q)-\mathbf{P_M}_y}{(\mathbf{S_B}_x(q)-\mathbf{P_M}_x)^2}\cdot(x-\mathbf{P_M}_x)^2+\mathbf{P_M}_y,\\\
...
$$
\begin{array}{l}
T_{1T}: y=\dfrac{\mathbf{S_T}_y-qD-\mathbf{P_M}_y}{(\mathbf{S_T}_x-\mathbf{P_M}_x)^2}\cdot(x-\mathbf{P_M}_x)^2+\mathbf{P_M}_y,\\\
T_{2T}: x=\dfrac{(\mathbf{S_T}_x-\mathbf{P_M}_x)}{(\mathbf{S_T}_y-qD-\mathbf{P_M}_y)^2}\cdot(y-\mathbf{P_M}_y)^2+\mathbf{P_M}_x, \\\
T_{1B}: y=\dfrac{\mathbf{S_B}_y+qD-\mathbf{P_M}_y}{(\mathbf{S_B}_x-\mathbf{P_M}_x)^2}\cdot(x-\mathbf{P_M}_x)^2+\mathbf{P_M}_y,\\\
...
$$\mathbf{P_0}=\left( x_0 \atop y(x_0) \right), \mathbf{P_2}=\left( x_1 \atop y(x_1) \right)$$
...
$$
\begin{array}{l}
\mathbf{P_0}=\mathbf{P_M}=\begin{pmatrix} R_M \\\ H-R_M \end{pmatrix},\\\
\mathbf{P_2}=\left[\begin{pmatrix} \dfrac{\mathbf{P_M}_x+\mathbf{S_X}_x}{2} \\\ \mathbf{P_0}_y \end{pmatrix}, \begin{pmatrix}  \mathbf{P_0}_x \\\ \dfrac{\mathbf{P_M}_y+\mathbf{S_X}_y\pm qD}{2} \end{pmatrix}\right], \\\
...
$$
    t_d=\dfrac{S}{\|\mathbf{B}'(t_0)\|}=\dfrac{S}{\|2(\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2})\cdot t+2(\mathbf{P_1}-\mathbf{P_0})\|}
$$
...
$$
\begin{array}{l}
\| \mathbf{B}(t_{0}+t_\Delta) - \mathbf{B}(t_{0})\|= \\\
=\| (\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2})\cdot (t_0+t_\Delta)^2+2(\mathbf{P_1}-\mathbf{P_0})\cdot (t_0+t_\Delta) + \mathbf{P_0} - ((\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2})\cdot t_0^2+2(\mathbf{P_1}-\mathbf{P_0})\cdot t_0 + \mathbf{P_0})\|= \\\
=\| (\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2})\cdot (t_0^2+2t_0t_\Delta+t_\Delta^2)+2(\mathbf{P_1}-\mathbf{P_0})\cdot (t_0+t_\Delta)  - (\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2})\cdot t_0^2 - 2(\mathbf{P_1}-\mathbf{P_0})\cdot t_0 \|= \\\
=\| (\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2})\cdot (2t_0t_\Delta+t_\Delta^2)+2(\mathbf{P_1}-\mathbf{P_0})\cdot t_\Delta\|= \\\
...
$$
\begin{array}{l}
\| t_\Delta^2\cdot(\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2})+t_\Delta\cdot(2t_0(\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2})+2(\mathbf{P_1}-\mathbf{P_0}))\| = S \\
\| t_\Delta^2\cdot \mathbf{C}+t_\Delta\cdot(2t_0\mathbf{C}+2\mathbf{D})\| = S  \\
\sqrt{(t_\Delta^2\cdot \mathbf{C_x}+t_\Delta\cdot(2t_0\mathbf{C_x}^2+2\mathbf{D_x}^2))^2 + (t_\Delta^2\cdot \mathbf{C_y}+t_\Delta\cdot(2t_0\mathbf{C_x}^2+2\mathbf{D_y}^2))^2} = S  \\
(t_\Delta^2\cdot \mathbf{C_x}+t_\Delta\cdot(2t_0\mathbf{C_x}^2+2\mathbf{D_x}^2))^2 + (t_\Delta^2\cdot \mathbf{C_y}+t_\Delta\cdot(2t_0\mathbf{C_x}^2+2\mathbf{D_y}^2))^2 = S^2  \\
t_\Delta^2\cdot\left[(t_\Delta\cdot \mathbf{C_x}+(2t_0\mathbf{C_x}^2+2\mathbf{D_x}^2))^2 + (t_\Delta\cdot \mathbf{C_y}+(2t_0\mathbf{C_x}^2+2\mathbf{D_y}^2))^2\right] = S^2  \\
t_\Delta^2\cdot\left[(t_\Delta^2\cdot \mathbf{C_x}^2+2t_\Delta\cdot \mathbf{C_x}(2t_0\mathbf{C_x}^2+2\mathbf{D_x}^2)+(2t_0\mathbf{C_x}^2+2\mathbf{D_x}^2)^2) + (t_\Delta^2\cdot \mathbf{C_y}^2+2t_\Delta\cdot \mathbf{C_y}(2t_0\mathbf{C_y}^2+2\mathbf{D_y}^2)+(2t_0\mathbf{C_y}^2+2\mathbf{D_y}^2)^2)\right] = S^2  \\
...
\left[
\begin{array}{l}
+a_{5}+\frac{1}{2}\sqrt{\frac{b^{2}}{2a^{2}}-\frac{4c}{3a}+a_{6}-a_{4}}-\frac{b}{4a}\\
+a_{5}-\frac{1}{2}\sqrt{\frac{b^{2}}{2a^{2}}-\frac{4c}{3a}+a_{6}-a_{4}}-\frac{b}{4a}\\
-a_{5}+\frac{1}{2}\sqrt{\frac{b^{2}}{2a^{2}}-\frac{4c}{3a}-a_{6}-a_{4}}-\frac{b}{4a}\\
-a_{5}-\frac{1}{2}\sqrt{\frac{b^{2}}{2a^{2}}-\frac{4c}{3a}-a_{6}-a_{4}}-\frac{b}{4a}\\
\end{array}
...
a_{5}=\frac{1}{2}\sqrt{\frac{b^{2}}{4a^{2}}+a_{4}-\frac{2c}{3a}} ,\\
a_{4}=\frac{a_{3}}{3\cdot2^{\frac{1}{3}}a}+\frac{2^{\frac{1}{3}}a_{2}}{3a\cdot a_{3}} ,
a_{3}=\left(\sqrt{a_{1}^{2}-4a_{2}^{3}}+a_{1}\right)^{\frac{1}{3}} ,\\
a_{2}=\left(c^{2}-12ad^{2}\right) , a_{1}=\left(72acd^{2}-27b^{2}d^{2}+2c^{3}\right) ,\\
a=\left(A_{1}.x^{2}+A_{1}.y^{2}\right), b=\left(2A_{1}.xA_{2}.x+2A_{1}.yA_{2}.y\right),
c=\left(A_{2}.x^{2}+A_{2}.y^{2}
\right), d=S, \\
...
$(\mathbf{P_1}-\mathbf{P_0}) = \left(0 \atop 0\right)$ - когда первая и вторая точка кривой совпадают;  
$(\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2}) = \left(0 \atop 0\right)$ - когда точки лежат на одной прямой и вторая равноудалена от первой и третьей
...
При $q=\dfrac12$ вторая точка равноудалена от первой и третьей точки - $(\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2}) = \left(0 \atop 0\right)$ и кривая становиться прямой:
...
При $q=0$  первая и вторая точка кривой совпадают - $(\mathbf{P_1}-\mathbf{P_0}) = \left(0 \atop 0\right)$ и кривая становиться прямой:
...
$$
\begin{array}{l}
\dfrac{S}{\|2(\mathbf{P_2}-\mathbf{P_0})\cdot t_0\|} = t_0 \\
t_0 = \dfrac{S}{2t_0\cdot\|(\mathbf{P_2}-\mathbf{P_0})\|} \\
t_0^2 = \dfrac{S}{2\cdot\|(\mathbf{P_2}-\mathbf{P_0})\|} \\
...
$$
\begin{array}{l}
\dfrac{\mathbf{S_{T_y}}(q)-\mathbf{P_{M_y}}}{(\mathbf{S_{T_x}}(q)-\mathbf{P_{M_x}})^2}(\mathbf{S_{B_x}}-\mathbf{P_{M_x}})^2+\mathbf{P_{M_y}} + Y_1=\mathbf{S_{B_y}}\\
\dfrac{\mathbf{S_{B_y}}(q)-\mathbf{P_{M_y}}}{(\mathbf{S_{B_x}}(q)-\mathbf{P_{M_x}})^2}(\mathbf{S_{T_x}}-\mathbf{P_{M_x}})^2+\mathbf{P_{M_y}} + Y_2=\mathbf{S_{T_y}}\\
\dfrac{\mathbf{S_{T_x}}(q)-\mathbf{P_{M_x}}}{(\mathbf{S_{T_y}}(q)-\mathbf{P_{M_y}})^2}(\mathbf{S_{B_y}}-\mathbf{P_{M_y}} - Y_3)^2+\mathbf{P_{M_x}} =\mathbf{S_{B_x}}\\
\dfrac{\mathbf{S_{B_x}}(q)-\mathbf{P_{M_x}}}{(\mathbf{S_{B_y}}(q)-\mathbf{P_{M_y}})^2}(\mathbf{S_{T_y}}-\mathbf{P_{M_y}} - Y_4)^2+\mathbf{P_{M_x}} =\mathbf{S_{T_x}}\\
\end{array}
$$
...
$$
\begin{array}{l}
\dfrac{\mathbf{S_{T_y}}+qD-\mathbf{P_{M_y}}}{(\mathbf{S_{T_x}}-\mathbf{P_{M_x}})^2}(\mathbf{S_{B_x}}-\mathbf{P_{M_x}})^2+\mathbf{P_{M_y}} + Y_1=\mathbf{S_{B_y}}\\
\dfrac{\mathbf{S_{B_y}}-qD-\mathbf{P_{M_y}}}{(\mathbf{S_{B_x}}-\mathbf{P_{M_x}})^2}(\mathbf{S_{T_x}}-\mathbf{P_{M_x}})^2+\mathbf{P_{M_y}} + Y_2=\mathbf{S_{T_y}}\\
\dfrac{\mathbf{S_{T_x}}-\mathbf{P_{M_x}}}{(\mathbf{S_{T_y}}+qD-\mathbf{P_{M_y}})^2}(\mathbf{S_{B_y}}-\mathbf{P_{M_y}} - Y_3)^2+\mathbf{P_{M_x}} =\mathbf{S_{B_x}}\\
\dfrac{\mathbf{S_{B_x}}-\mathbf{P_{M_x}}}{(\mathbf{S_{B_y}}-qD-\mathbf{P_{M_y}})^2}(\mathbf{S_{T_y}}-\mathbf{P_{M_y}} - Y_4)^2+\mathbf{P_{M_x}} =\mathbf{S_{T_x}}\\
\end{array}
$$
...
$$
Y_1=(\mathbf{S_{B_y}} - \mathbf{P_{M_y}}) - (\mathbf{S_{T_y}}-\mathbf{P_{M_y}}) \left(\dfrac{\mathbf{S_{B_x}}-\mathbf{P_{M_x}}}{\mathbf{S_{T_x}}-\mathbf{P_{M_x}}}\right)^2 - qD\cdot \left(\dfrac{\mathbf{S_{B_x}}-\mathbf{P_{M_x}}}{\mathbf{S_{T_x}}-\mathbf{P_{M_x}}}\right)^2
$$

$$
Y_2=(\mathbf{S_{T_y}} - \mathbf{P_{M_y}}) - (\mathbf{S_{B_y}}-\mathbf{P_{M_y}}) \left(\dfrac{\mathbf{S_{T_x}}-\mathbf{P_{M_x}}}{\mathbf{S_{B_x}}-\mathbf{P_{M_x}}}\right)^2 + qD\cdot \left(\dfrac{\mathbf{S_{T_x}}-\mathbf{P_{M_x}}}{\mathbf{S_{B_x}}-\mathbf{P_{M_x}}}\right)^2
$$

$$
Y_3=(\mathbf{S_{B_y}} - \mathbf{P_{M_y}}) - (\mathbf{S_{T_y}}-\mathbf{P_{M_y}}) \left(\dfrac{\mathbf{S_{B_x}}-\mathbf{P_{M_x}}}{\mathbf{S_{T_x}}-\mathbf{P_{M_x}}}\right)^{\frac12} - qD\cdot \left(\dfrac{\mathbf{S_{B_x}}-\mathbf{P_{M_x}}}{\mathbf{S_{T_x}}-\mathbf{P_{M_x}}}\right)^{\frac12}
$$

$$
Y_4=(\mathbf{S_{T_y}} - \mathbf{P_{M_y}}) - (\mathbf{S_{B_y}}-\mathbf{P_{M_y}}) \left(\dfrac{\mathbf{S_{T_x}}-\mathbf{P_{M_x}}}{\mathbf{S_{B_x}}-\mathbf{P_{M_x}}}\right)^{\frac12} + qD\cdot \left(\dfrac{\mathbf{S_{T_x}}-\mathbf{P_{M_x}}}{\mathbf{S_{B_x}}-\mathbf{P_{M_x}}}\right)^{\frac12}
$$
...
$$
\begin{array}{l}
A = (\mathbf{S_{B_y}} - \mathbf{P_{M_y}}) = (H-(R_H+2\sqrt{R_HR_M}+R_M))\\
B = (\mathbf{S_{T_y}}-\mathbf{P_{M_y}}) = (H-2R_M) \\
C = \left(\dfrac{\mathbf{S_{B_x}}-\mathbf{P_{M_x}}}{\mathbf{S_{T_x}}-\mathbf{P_{M_x}}}\right) = \left(\dfrac{W-(R_H+2\sqrt{R_HR_M}+R_M)}{W-2R_M}\right) \\
D = H-(R_H+2\sqrt{R_HR_M}+R_M) = A \\
\begin{array}{ll}
Y_1= A - B\cdot C^2 -  qA\cdot C^2 & = A -(B+qA)\cdot C^2 \\
Y_2= B - A\cdot C^{-2} +  qA\cdot C^{-2} &= B+(q-1)\cdot A\cdot C^{-2}  \\
Y_3= A - B\cdot C^{\frac12} -  qA\cdot C^{\frac12} &= A -(B+qA)\cdot C^{\frac12}\\
Y_4= B - A \cdot C^{-\frac12} +  qA\cdot C^{-\frac12} &= B+(q-1)\cdot A\cdot C^{-\frac12}\\
\end{array}
\end{array}
$$
...
$$
\begin{array}{l}
y'(x_0)(x_I-x_0)+y(x_0) = y'(x_1)(x_I-x_1)+y(x_1)\\
...
$$
\begin{array}{l}
\mathbf{B}'(t_0)(t_I-t_0)+\mathbf{B}(t_0) = \mathbf{B}'(t_1)(t_I-t_1)+\mathbf{B}(t_1) \\
...
$$
\begin{array}{l}
\mathbf{B}(x) = (\mathbf{P_0}-2\mathbf{P_1}+\mathbf{P_2})\cdot t^2+2(\mathbf{P_1}-\mathbf{P_0})\cdot t + \mathbf{P_0}\\
...
\mathbf{N} = (\mathbf{P_1}-\mathbf{P_0}), \\
\mathbf{B}(x) = \mathbf{K}\cdot t^2+2\mathbf{N}\cdot t + \mathbf{P_0}\\
...
t_I=\dfrac{(\mathbf{B}'(t_0)t_0-\mathbf{B}'(t_1)t_1)-(\mathbf{B}(t_0)-\mathbf{B}(t_1))}{\mathbf{B}'(t_0)-\mathbf{B}'(t_1)} \\
=\dfrac{
    ((2\mathbf{K}\cdot t_0+2\mathbf{N})t_0-(2\mathbf{K}\cdot t_1+2\mathbf{N})t_1)-(\mathbf{K}\cdot t_0^2+2\mathbf{N}\cdot t_0 + \mathbf{P_0}-(\mathbf{K}\cdot t_1^2+2\mathbf{N}\cdot t_1 + \mathbf{P_0}))}{(2\mathbf{K}\cdot t_0+2\mathbf{N})-(2\mathbf{K}\cdot t_1+2\mathbf{N})} \\
=\dfrac{
    (2\mathbf{K}\cdot (t_0^2-t_1^2)+2\mathbf{N}(t_0-t_1))-(\mathbf{K}\cdot (t_0^2-t_1^2)+2\mathbf{N}\cdot (t_0 - t_1))}{2\mathbf{K}\cdot (t_0-t_1)} \\
=\dfrac{
...
2. Средняя точка Безье определяется как пересечение касательных в точках аргумента $x_0$ и $x_1$:

$$\mathbf{P_1}=\left( \frac{x_1+x_2}{2} \atop y'(x_0)(\frac{x_1+x_2}{2}-x_0)+y(x_0)\right)$$ 
